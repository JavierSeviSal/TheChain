...
from .models import (
    Card, CardType, CardFront, CardBack, ActionSlot, CleanupAction,
    CompetitionEffect, Deck,
)
...
def build_action_deck() -> list[Card]:
    ...
    # ── Card 1 ──────────────────────────────────────────────────────────
    cards.append(Card(
        id=1, card_type=CardType.ACTION, card_number=1,
        front=CardFront(
            actions=[
                ActionSlot(1, "recruit_marketeer", "Zeppelin Pilot", fallback_food="burger"),
                ActionSlot(2, "recruit_employee", "Burger Chef"),
                ActionSlot(3, "move_waitress", "+1"),
                ActionSlot(4, "recruit_employee", "Gourmet Food Critic",
                           requires_module="coffee", fallback_food="burger"),
            ],
    ...
    # ── Card 2 ──────────────────────────────────────────────────────────
    cards.append(Card(
        id=2, card_type=CardType.ACTION, card_number=2,
        front=CardFront(
            actions=[
                ActionSlot(1, "recruit_marketeer", "Zeppelin Pilot", fallback_food="pizza"),
                ActionSlot(2, "recruit_employee", "Sushi Chef",
                           requires_module="sushi", fallback_food="pizza"),
                ActionSlot(3, "move_waitress", "+1"),
    ...
    # ── Card 3 ──────────────────────────────────────────────────────────
    cards.append(Card(
        id=3, card_type=CardType.ACTION, card_number=3,
        front=CardFront(
            actions=[
                ActionSlot(1, "recruit_marketeer", "Zeppelin Pilot", fallback_food="sushi"),
    ...
    # ── Card 4 ──────────────────────────────────────────────────────────
    cards.append(Card(
        id=4, card_type=CardType.ACTION, card_number=4,
        front=CardFront(
            actions=[
                ActionSlot(1, "recruit_marketeer", "Mass Marketeer", fallback_food="noodle"),
    ...
    # ── Card 5 ──────────────────────────────────────────────────────────
    cards.append(Card(
        id=5, card_type=CardType.ACTION, card_number=5,
        front=CardFront(
            actions=[
    ...
    # ── Card 6 ──────────────────────────────────────────────────────────
    cards.append(Card(
        id=6, card_type=CardType.ACTION, card_number=6,
        front=CardFront(
            actions=[
                ActionSlot(1, "recruit_employee", "Guru"),
    ...
    # ── Card 7 ──────────────────────────────────────────────────────────
    cards.append(Card(
        id=7, card_type=CardType.ACTION, card_number=7,
        front=CardFront(
            actions=[
                ActionSlot(1, "recruit_marketeer", "Lead Barista",
                           requires_module="coffee", fallback_food="coffee"),
    ...
    # ── Card 8 ──────────────────────────────────────────────────────────
    cards.append(Card(
        id=8, card_type=CardType.ACTION, card_number=8,
        front=CardFront(
            actions=[
                ActionSlot(1, "recruit_marketeer", "Rural Marketeer", fallback_food="burger"),
    ...
    # ── Card 9 ──────────────────────────────────────────────────────────
    cards.append(Card(
        id=9, card_type=CardType.ACTION, card_number=9,
        front=CardFront(
            actions=[
                ActionSlot(1, "recruit_employee", "Executive VP"),
                ActionSlot(2, "move_distance", "-3"),
                ActionSlot(3, "recruit_employee", "Gourmet Food Critic",
                           requires_module="coffee", fallback_food="pizza"),
    ...
    # ── Card 10 ─────────────────────────────────────────────────────────
    cards.append(Card(
        id=10, card_type=CardType.ACTION, card_number=10,
        front=CardFront(
            actions=[
                ActionSlot(1, "recruit_marketeer", "Rural Marketeer", fallback_food="pizza"),
                ActionSlot(2, "recruit_employee", "Burger Chef"),
                ActionSlot(3, "move_distance", "-1"),
    ...
    # ── Card 11 ─────────────────────────────────────────────────────────
    cards.append(Card(
        id=11, card_type=CardType.ACTION, card_number=11,
        front=CardFront(
            actions=[
                ActionSlot(1, "recruit_marketeer", "Kimchi Master",
                           requires_module="kimchi", fallback_food="kimchi"),
    ...
    # ── Card 12 ─────────────────────────────────────────────────────────
    cards.append(Card(
        id=12, card_type=CardType.ACTION, card_number=12,
        front=CardFront(
            actions=[
    ...
    # ── Card 13 ─────────────────────────────────────────────────────────
    cards.append(Card(
        id=13, card_type=CardType.ACTION, card_number=13,
        front=CardFront(
            actions=[
                ActionSlot(1, "recruit_employee", "Sushi Chef",
                           requires_module="sushi", fallback_food="sushi"),
                ActionSlot(2, "move_waitress", "+1"),
                ActionSlot(3, "recruit_employee", "Marketing Trainee"),
                ActionSlot(4, "recruit_employee", "HR Director"),
            ],
    ...
    # ── Card 14 ─────────────────────────────────────────────────────────
    cards.append(Card(
        id=14, card_type=CardType.ACTION, card_number=14,
        front=CardFront(
            actions=[
    ...
    # ── Card 15 ─────────────────────────────────────────────────────────
    cards.append(Card(
        id=15, card_type=CardType.ACTION, card_number=15,
        front=CardFront(
            actions=[
                ActionSlot(1, "recruit_marketeer", "Noodle Chef",
                           requires_module="noodle", fallback_food="noodle"),
    ...
    # ── Card 16 ─────────────────────────────────────────────────────────
    cards.append(Card(
        id=16, card_type=CardType.ACTION, card_number=16,
        front=CardFront(
            actions=[
                ActionSlot(1, "recruit_employee", "Regional Manager"),
    ...
    # ── Card 17 ─────────────────────────────────────────────────────────
    cards.append(Card(
        id=17, card_type=CardType.ACTION, card_number=17,
        front=CardFront(
            actions=[
    ...
    # ── Card 18 ─────────────────────────────────────────────────────────
    cards.append(Card(
        id=18, card_type=CardType.ACTION, card_number=18,
        front=CardFront(
            actions=[
                ActionSlot(1, "recruit_marketeer", "Lead Barista",
                           requires_module="coffee", fallback_food="coffee"),
    ...
    # ── Card 19 ─────────────────────────────────────────────────────────
    cards.append(Card(
        id=19, card_type=CardType.ACTION, card_number=19,
        front=CardFront(
            actions=[
                ActionSlot(1, "recruit_marketeer", "Mass Marketeer", fallback_food="burger"),
                ActionSlot(2, "recruit_employee", "Pizza Chef"),
                ActionSlot(3, "move_distance", "-1"),
    ...
    # ── Card 20 ─────────────────────────────────────────────────────────
    cards.append(Card(
        id=20, card_type=CardType.ACTION, card_number=20,
        front=CardFront(
            actions=[
                ActionSlot(1, "recruit_marketeer", "Noodle Chef",
                           requires_module="noodle", fallback_food="noodle"),
...
def build_warm_deck() -> list[Card]:
    ...
    for i, card_num in enumerate([1, 2, 3, 4]):
        ...
        cards.append(Card(
            id=100 + card_num, card_type=CardType.WARM, card_number=card_num,
...
def build_cool_deck() -> list[Card]:
    ...
    for i, card_num in enumerate([1, 2, 3, 4]):
        loss_items = [
            ["burger"], ["pizza"], ["sushi"], ["noodle"],
        ]
        cards.append(Card(
            id=200 + card_num, card_type=CardType.COOL, card_number=card_num,
            competition_effect=CompetitionEffect(
    ...
    for i, card_num in enumerate([9, 10, 11, 12]):
        loss_items = [
            ["burger", "beer"], ["pizza", "lemonade"],
            ["sushi", "coffee"], ["noodle", "kimchi"],
        ]
        cards.append(Card(
            id=200 + card_num, card_type=CardType.COOL, card_number=card_num,
            competition_effect=CompetitionEffect(
